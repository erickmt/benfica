<div id="wrapper">
	...
	<script type="text/javascript" charset="utf-8" src="js/table.forma_pagamento.js"></script>	
	...
	<div id="page-wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Gestão de Formas de Pagamento</h1>
			</div>
		</div>
